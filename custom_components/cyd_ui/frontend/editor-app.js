...
const state={ui:null,backendMap:null,catalog:null,icons:[],entities:[],ldrVoltage:null,deviceBrightness:null,deviceMode:null,deviceNight:null,deviceTouchCalibration:null,touchCalibrationWaiting:false,touchCalibrationBaseline:null,selectedPage:0,editingSettings:false,editingReminder:false,editingHistory:false,history:[],currentRevision:0,scheduledReminders:[],reminderScheduleAt:"",reminderRepeat:"once",reminderWeekdays:[],reminderDraft:{reminder_id:"aviso_manual",title:"Recordatorio",message:"",level:"reminder",sound_mode:"once",alarm_duration:120,snooze_minutes:0},collapsed:new Set()};
