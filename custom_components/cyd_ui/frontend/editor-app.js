...
renderPreview=function renderRichPreview(){
  ...
  if(page.template==="button_grid"){
    ...
    screen.innerHTML='<div class="template-face media-face"><strong class="template-title"></strong><span class="template-arrow previous">&#8249;</span><span class="template-arrow next">&#8250;</span><button class="media-player-prev">&#8249;</button><div class="media-player">Reproductor</div><button class="media-player-next">&#8250;</button><div class="media-title">Canción o emisora</div><div class="media-artist">Artista</div><div class="media-station">Emisora</div><button class="media-previous">Anterior</button><button class="media-play">Play/Pausa</button><button class="media-next">Siguiente</button><button class="media-vol-down">Vol -</button><div class="media-volume">Vol 42 %</div><button class="media-vol-up">Vol +</button></div>';
    screen.querySelector(".template-title").textContent=page.title||"Multimedia";
    screen.querySelector(".media-previous").textContent=label("previous","Anterior");
    screen.querySelector(".media-play").textContent=label("play_pause","Play/Pausa");
    screen.querySelector(".media-next").textContent=label("next","Siguiente");
    screen.querySelector(".media-vol-down").textContent=label("volume_down","Vol -");
    screen.querySelector(".media-vol-up").textContent=label("volume_up","Vol +");
  }
